		    ...
		    <div class="card">
				...
				<c:forEach var="t" items="${todoList}">
					<div class="m-2">
						...
						<br>
						<span style="color:#A6A6A6; font-size:12px;">${t.createDate} | ${t.updateDate} | <a href="${pageContext.request.contextPath}/member/modifyTodo?todoNo=${t.todoNo}">수정</a> | <a href="${pageContext.request.contextPath }/member/removeTodo?todoNo=${t.todoNo}&todoDate=${todoDate}">삭제</a></span>
					</div>
				</c:forEach>
		    </div>
		    ...
		    <div class="card">
		    	<div class="w-100 text-center mb-3">
					...
					<!-- AddTodoController.doPost() -->
						...
						<div>
							<a href="${pageContext.request.contextPath}/member/calendar">뒤로가기</a>
						</div>
